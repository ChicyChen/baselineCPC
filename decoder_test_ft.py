...
def main():
    ...
    checkpoint_path = os.path.join(
        args.prefix, 'CPC_1layer_1d_static_decoder_lr%s_wd%s_la%s' % (args.lr, args.wd, args.la), 'epoch%s.pth.tar' % str(args.epoch)) 
    ...
    vis_folder = os.path.join(
        args.visual, 'ft_CPC_1layer_1d_static_decoder_lr%s_wd%s_la%s_epoch%s' % (args.lr, args.wd, args.la, args.epoch))
