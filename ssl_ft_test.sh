...
python action_test.py --backbone_folder $bbfoler --backbone_epoch $ftepoch --epochs $ftepoch --which_split $split --model 2
# 2layer_2dGRU_static_B2, sa
...
python action_test.py --backbone_folder $bbfoler --backbone_epoch $ftepoch --epochs $ftepoch --which_split $split --model 3
# 2layer_2dGRU_static_A1, sa
...
python action_test.py --backbone_folder $bbfoler --backbone_epoch $ftepoch --epochs $ftepoch --which_split $split --model 4
# 2layer_2dGRU_static_A2, sa
...
python action_test.py --backbone_folder $bbfoler --backbone_epoch $ftepoch --epochs $ftepoch --which_split $split --model 5
# 2layer_2dGRU_static_R1, sa
...
python action_test.py --backbone_folder $bbfoler --backbone_epoch $ftepoch --epochs $ftepoch --which_split $split --model 6
# 2layer_2dGRU_static_B1
