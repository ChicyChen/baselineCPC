...
class CPC_2layer_2d_static_C(nn.Module):
    def __init__(self, code_size=[512, 512], pred_step=3, nsub=3, useout=False):
        super().__init__()
...
class action_CPC_2layer_2d_static_C(nn.Module):
