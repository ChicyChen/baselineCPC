...
do 
    ...
    # python ssl_learning.py --epochs $bbepoch --model 7 --downsample $downsample --pred_step $pred_step --nsub $nsub --which_split $split --batch_size $batchsize --loss_mode $loss_mode
    # python ssl_learning.py --epochs $bbepoch --model 7 --downsample $downsample --pred_step $pred_step --nsub $nsub --which_split $split --batch_size $batchsize --loss_mode $loss_mode --seeall
    ...
    # python action_recognation.py --backbone_folder $bbfoler --backbone_epoch $bbepoch --epochs $ftepoch --which_split $ft_split --model 7
    ...
    # python action_test.py --backbone_folder $bbfoler --backbone_epoch $ftepoch --which_split $ft_split --model 7
